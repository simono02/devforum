  ...
  <aside class="sidebar" :class="{ collapsed }">
    <div class="sidebar-top">
      <router-link to="/" class="logo">
        ...
        <span v-else class="logo-sm">df</span>
      </router-link>
      <div class="admin-pill" v-if="!collapsed">admin</div>
    ...
    <nav class="nav">
      <div class="nav-section" v-if="!collapsed">Overview</div>
      ...
      <div class="nav-section" v-if="!collapsed">Content</div>
      <router-link class="nav-item" to="/admin/posts" active-class="active">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        <span v-if="!collapsed">All Posts</span>
      </router-link>

      <div class="nav-section" v-if="!collapsed">People</div>
      <router-link class="nav-item" to="/admin/users" active-class="active">
...
.admin-pill {
  ...
  padding: 0.15rem 0.45rem; border-radius: 20px; border: 1px solid var(--border-mid);
